    ...
    <div id="nav">
            ...
            <nav>
                <ul id="right">
                    ...
                    <li><a href="/interfaces/Register.html">Registrarse</a></li> -->
...
#rowSucces{
    ...
    justify-content: center;
    text-align: center;
    background-color: rgba(83, 144, 217, 0.4);
}
#search{
    margin-top: 0.6em;
    margin-bottom: 0.6em;
...
.container-card .cardTour:hover{
    transform: translateY(-15px);
    box-shadow: 0 12px 16px rgba(0, 0, 0, 0.4);
}

.container-card .cardTour .image{
    width: 330px;
    height: 220px;

}
.container-card .cardTour h4{
    color: black;
    font-weight: 600;
}

.container-card .cardTour p{
    color: rgba(0, 0, 0, 0.8);
    padding: 0 1rem;
    font-size: 16px;
    font-weight: 300;
}
.container-card .cardTour a{
    font-weight: 500;
    text-decoration: none;
    color: #3498db;
